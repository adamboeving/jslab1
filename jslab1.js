...
console.log(`My name is ${hisName} and I like pineapples on pizza. I am currently ${hisAge} years old and my birthday is on ${hisBirthday}.`) }
else if (pineapplePizza === false) {
console.log(`My name is ${hisName} and Im not into pineapples on pizza. I am currently ${hisAge} years old and my birthday is on ${hisBirthday}.`)
}
...
if (randomNumber !== 5) {
    ...
    counter++;
    console.log(`${randomNumber} === 5. it took ${counter} iterations to randomly generate the numer 5`);
    break;
}
